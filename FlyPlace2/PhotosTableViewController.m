...
- (void)setPlace:(NSDictionary *)newPlace
{
    ...
    for (NSDictionary *photoInfo in self.photosAtPlace) {
        [Photo photoWithFlickrData:photoInfo placeWithName:self.title inManagedObjectContext:self.managedObjectContext];
    }
}
